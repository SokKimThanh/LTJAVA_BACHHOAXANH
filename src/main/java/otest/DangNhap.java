...
public class DangNhap extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnThemAccount.setText("Thêm Account");
    ...
    private void btnThemAccountActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemAccountActionPerformed
        // TODO add your handling code here:
        frmDangKy l = new frmDangKy();
        l.setVisible(true);//Hiển thị from đăng nhập
        this.dispose();//Thoát cửa sổ đăg nhập
